function initMapT() {
  ...
  var map1 = new google.maps.Map(
      document.getElementById('map1T'), {zoom: 15, center: barcelona});
  var marker = new google.maps.Marker({position: barcelona, map: map1});

  var liverpool = {lat: 53.430855, lng: -2.960841};
  var map2 = new google.maps.Map(
      document.getElementById('map2T'), {zoom: 15, center: liverpool});
  ...
  var map3 = new google.maps.Map(
      document.getElementById('map3T'), {zoom: 15, center: tottenham});
  ...
  var map4 = new google.maps.Map(
      document.getElementById('map4T'), {zoom: 15, center: amsterdam});
